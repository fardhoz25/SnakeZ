...
public class Board extends JPanel implements ActionListener {
    ...
    private void gameOver(Graphics g) {
        ...
        g.drawString(restartMsg, (B_WIDTH - metr.stringWidth(restartMsg)) / 2, B_HEIGHT / 2 + 40);
    }
    ...
    private class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if ((key == KeyEvent.VK_LEFT) && (!rightDirection) && (!paused)) {
                leftDirection = true;
                upDirection = false;
                downDirection = false;
            }

            if ((key == KeyEvent.VK_RIGHT) && (!leftDirection) && (!paused)) {
                rightDirection = true;
                upDirection = false;
                downDirection = false;
            }

            if ((key == KeyEvent.VK_UP) && (!downDirection) && (!paused)) {
                upDirection = true;
                rightDirection = false;
                leftDirection = false;
            }

            if ((key == KeyEvent.VK_DOWN) && (!upDirection) && (!paused)) {
                downDirection = true;
                rightDirection = false;
                leftDirection = false;
            }
